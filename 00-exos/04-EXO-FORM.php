    ...
    <div class="container bg-white mt-2 mb-2 m-auto p-2">
        ...
        <section class="row">
            ...
            <div class="col-md-8 bg-light">
                <h2>formulaire</h2>
                <ul>
                    <li>EXO : faire un formulaire avec les champs prénoms, nom, email, adresse, code postal ville et
                        téléphone<br>
                    ...
                    <li>l'attribut action de la balise form contient donc le nom de ce fichier placé dans le même
                        dossier que notre page avec le form</li>
                </ul>
                <hr>
